...
class DebugToolbar(object):
    ...
    def __init__(self, request):
        ...
        self.default_panels = (
            'core.middleware.debug_toolbar.panels.version.VersionDebugPanel',
            'core.middleware.debug_toolbar.panels.timer.TimerDebugPanel',
            'core.middleware.debug_toolbar.panels.settings_vars.SettingsVarsDebugPanel',
            'core.middleware.debug_toolbar.panels.headers.HeaderDebugPanel',
            'core.middleware.debug_toolbar.panels.request_vars.RequestVarsDebugPanel',
            #'core.middleware.debug_toolbar.panels.sql.SQLDebugPanel',
            'core.middleware.debug_toolbar.panels.template.TemplateDebugPanel',
            #'debug_toolbar.panels.cache.CacheDebugPanel',
            'core.middleware.debug_toolbar.panels.signals.SignalDebugPanel',
            #'core.middleware.debug_toolbar.panels.logger.LoggingPanel',
        )
        self.load_panels()
