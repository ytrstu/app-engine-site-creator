...
from core.middleware.debug_toolbar import urls
from core.middleware.debug_toolbar.toolbar.loader import DebugToolbar
...
class DebugToolbarMiddleware(object):
    ...
    def _show_toolbar(self, request):
        ...
        if request.is_ajax() and not \
            request.path.startswith(os.path.join('/', urls._PREFIX)):
